Futplaycoin-qt: Qt4 GUI for Futplaycoin
===============================
...
Alternatively, install Qt Creator and open the `Futplaycoin-qt.pro` file.

An executable named `Futplaycoin-qt` will be built.
...
A warning for people using the *static binary* version of Futplaycoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of Futplaycoin is linked against libdb5.3.
...
installed causes Futplaycoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
