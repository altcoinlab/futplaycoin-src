...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("FUT");
    case mBTC: return QString("mFUT");
    case uBTC: return QString::fromUtf8("μFUT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Futplaycoins"));
    case mBTC: return QString(QObject::tr("Milli-Futplaycoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Futplaycoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
